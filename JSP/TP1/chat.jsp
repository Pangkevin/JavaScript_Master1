...
<%! 
	...
	class MyMessage{
		...
		String msg;
		String receiver;
		public MyMessage(String s, String m){ sender = s; msg = m; receiver = r;};
...
<% if(request.getParameter("newmsg")!="" && request.getParameter("newmsg")!=null){
	msgs.add(new MyMessage(session.getAttribute("username").toString(),request.getParameter("newmsg")), session.getAttribute("receiver").toString());
}
%>
...
<input type="text" name="receiver"/> <input type="submit" value="Add"/><br />
<input type="text" name="newmsg"/> <input type="submit" value="Add"/><br />
</form>
